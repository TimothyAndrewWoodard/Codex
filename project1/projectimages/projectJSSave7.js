...
const puzzleimages = ['board.png', 'opposition.png', 'zugzwang.png', 'real.png'];
...
displayScore = () =>{
    document.getElementById('1') = userGrades[0];
    document.getElementById('2') = userGrades[1];
    document.getElementById('3') = userGrades[2];
}
