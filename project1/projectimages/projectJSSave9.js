...
button.addEventListener('click', () => {
  ...
  document.getElementById('testBox').innerHTML = userGrades[i];
  i++;
...
displayScore = () => {
  document.getElementById('0').innerHTML = 'Score Board';
  document.getElementById('1').innerHTML =
    'You got ' + score + ' questions right out of 3';
  document.getElementById('2').innerHTML = 'Question';
  document.getElementById('3').innerHTML = 'Grade';
  document.getElementById('4').innerHTML = '1';
  document.getElementById('5').innerHTML = userGrades[0];
  document.getElementById('6').innerHTML = '2';
  document.getElementById('7').innerHTML = userGrades[1];
  document.getElementById('8').innerHTML = '3';
  document.getElementById('9').innerHTML = userGrades[2];
};
